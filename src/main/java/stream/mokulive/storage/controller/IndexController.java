...
public class IndexController {
    ...
    @RequestMapping("/svg")
    @ResponseBody
    public String svg(HttpServletResponse response) {
        response.setHeader("Content-Type","image/svg+xml");
        return "<!DOCTYPE svg PUBLIC \"-//W3C//DTD SVG 20010904//EN\" \"http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd\">\n" +
